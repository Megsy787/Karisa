    ...
    <section id="projects" className="section-padding bg-slate-50">
      <div className="container mx-auto">
        <div className="flex flex-col items-center mb-16">
          ...
          <p className="text-slate-600 max-w-lg text-center mb-10">
                ...
                <div className="p-8">
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((t, index) => (
                      <span key={index} className="text-[10px] uppercase font-bold tracking-wider px-2 py-1 bg-slate-50 text-slate-500 rounded-md border border-slate-100">
                        {t}
                      </span>
                    ))}
                  </div>
