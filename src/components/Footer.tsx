      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            <Link href="#home" className="text-2xl font-bold tracking-tight text-white mb-6 block">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-slate-950 flex items-center justify-center text-slate-500 hover:bg-blue-600 hover:text-white transition-all"
                target="_blank" 
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-slate-950 flex items-center justify-center text-slate-500 hover:bg-[#25D366] hover:text-white transition-all"
                target="_blank" 
                rel="noopener noreferrer"
              >
